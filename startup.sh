...
sudo docker run -it -p 8888:8888 --sysctl="vm.overcommit_memory=1" --name jupyter_datascience_instance -v $(pwd)/notebooks:/home/jovyan/work jupyter_datascience:latest
